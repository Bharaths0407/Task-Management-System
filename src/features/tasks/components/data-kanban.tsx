...
export const DataKanban = ({ data, onChange }: DataKanbanProps) => {
    ...
    const onDragEnd = useCallback((result: DropResult) => {
        ...
        setTasks((prevTasks) => {
            ...
            //Create a new task obeject with potentially updated status
            ...
            //update positions for afftected  tasks in the destination column.
            ...
            // if the task moves between columns, update positions in the source column.
